class LanguageEnUs {
  static Map<String, String> get language {
    return {
      ...
      'weekValue': "%s / week",
      'yearValue': "%s / year",
      'weekShopDesc': "%s credits / weekly ",
      'yearShopDesc': "%s credits / yearly ",
      ...
      "recent": "Recent",
      "image": "Image",
      "promptHint": "Enter any prompt you desire to generate your AI video",
      "costsCreditsValue": "Costs %s Credits",
      "durationNotSupport": "1080p does not support 15s or 20s videos.",
