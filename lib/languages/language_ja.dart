class LanguageJa {
  static Map<String, String> get language {
    return {
      ...
      "weekValue": "%s / 週",
      "yearValue": "%s / 年",
      "weekShopDesc": "%sクレジット / 週",
      "yearShopDesc": "%sクレジット / 年",
      "creditsValue": "%sクレジット",
      ...
      "recent": "最近",
      "image": "画像",
      "promptHint": "AI動画を生成するために、希望するプロンプトを入力してください",
      "costsCreditsValue": "%s クレジットが必要です",
      "durationNotSupport": "1080pは15秒または20秒の動画をサポートしていません。",
